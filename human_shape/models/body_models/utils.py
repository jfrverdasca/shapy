...
def transform_mat(R: Tensor, t: Tensor) -> Tensor:
    ...
    return torch.cat(
        [F.pad(R, [0, 0, 0, 1], value=0.0), F.pad(t, [0, 0, 0, 1], value=1.0)], dim=2
    )
...
class JointsFromVerticesSelector(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        err_msg = (
            "Either pass a filename or triangle face ids, names and" " barycentrics"
        )
    ...
    def as_tensor(self, num_vertices: int, faces: Tensor) -> Tensor:
