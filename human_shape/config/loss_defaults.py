...
class BodyLossConfig(MultiStageLosses):
    ...
    left_hand_edge_2d: EdgeLoss = EdgeLoss(type="keypoint-edge", norm_type="l1")
    right_hand_edge_2d: EdgeLoss = EdgeLoss(type="keypoint-edge", norm_type="l1")
    ...
    left_hand_edge_3d: EdgeLoss = EdgeLoss(type="keypoint-edge", norm_type="l1")
    right_hand_edge_3d: EdgeLoss = EdgeLoss(type="keypoint-edge", norm_type="l1")
