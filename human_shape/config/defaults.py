...
from .body_model import BodyModel, body_conf
from .datasets_defaults import PoseConfig, ShapeConfig
from .datasets_defaults import pose_conf as pose_data_conf
from .datasets_defaults import shape_conf as shape_data_conf
from .loss_defaults import LossConfig
from .loss_defaults import conf as loss_cfg
from .network_defaults import Network
from .network_defaults import conf as network_cfg
...
class Evaluation:
    body: Metrics = Metrics(
        mpjpe=MPJPE(root_joints=("left_hip", "right_hip")),
        fscores_thresh=(
            10.0 / 1000,
            20.0 / 1000,
            50.0 / 1000,
