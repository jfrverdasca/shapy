...
def parse_args(argv=None):
    ...
    parser.add_argument(
        "--local_rank", default=0, type=int, help="ranking within the nodes"
    )
    parser.add_argument(
        "--num-gpus", dest="num_gpus", default=1, type=int, help="Number of gpus"
    )
    parser.add_argument(
        "--backend",
        dest="backend",
    ...
    cfg.network.use_sync_bn = cfg.network.use_sync_bn and cmd_args.num_gpus > 1
