...
class HRNet:
    ...
    pretrained_path: str = "../data/hrnet_v2/hrnetv2_w48_imagenet_pretrained.pth"
    stage1: Stage = Stage()
    stage2: Stage = Stage(
        num_branches=2, num_blocks=(4, 4), num_channels=(48, 96), block="BASIC"
    )
    stage3: Stage = Stage(
        num_modules=4,
        num_branches=3,
...
class SMPL(HMRLike):
    ...
    groups: Tuple[str] = (("betas", "global_rot", "body_pose", "camera"),)
